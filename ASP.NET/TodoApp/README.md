...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d10deaf6-9bfb-4e3e-8630-4ba50b7f62c1
```

> `d10deaf6-9bfb-4e3e-8630-4ba50b7f62c1` is the password of the certificate, you can change it to any password you want.
