...
```
127.0.0.1 abpsolution2-local-web
127.0.0.1 abpsolution2-local-webgateway
127.0.0.1 abpsolution2-local-authserver
```
...
Now, you can browse the URL: `https://abpsolution2-local-web`
