...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 2bedf99f-065e-4cb1-a913-cb10f33d399d
```

> `2bedf99f-065e-4cb1-a913-cb10f33d399d` is the password of the certificate, you can change it to any password you want.
