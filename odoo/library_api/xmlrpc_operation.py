...
if user_id:
    # create new books
    create_data = [
        {'name': 'Anna Karenina', 'published_date': '2019-01-26'},
        {'name': 'Book 3', 'published_date': '2019-02-12'},
        {'name': 'Papillon', 'published_date': '2019-05-08'},
        {'name': 'Cathédrale Notre-Dame de Paris', 'published_date': '2019-05-14'}
    ]
